...
use SendCloud\SendCloudV2\Model\ResourceModel\Carrier\Servicepointrate\CSV\ColumnResolver;
use SendCloud\SendCloudV2\Model\ResourceModel\Carrier\Servicepointrate\CSV\ColumnResolverFactory;
use SendCloud\SendCloudV2\Model\ResourceModel\Carrier\Servicepointrate\CSV\RowException;
use SendCloud\SendCloudV2\Model\ResourceModel\Carrier\Servicepointrate\CSV\RowParser;
    ...
    private function getHeaders(ReadInterface $file)
    {
        ...
        if ($headers === false || count($headers) < 5) {
            throw new LocalizedException(
                __('The Sendcloud Servicepoint Rates File Format is incorrect. Verify the format and try again.')
            );
        }
        return $headers;
    }
