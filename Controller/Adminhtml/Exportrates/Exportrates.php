<?php
namespace SendCloud\SendCloudV2\Controller\Adminhtml\Exportrates;
...
use SendCloud\SendCloudV2\Block\Adminhtml\Carrier\Servicepointrate\Grid;
...
class Exportrates extends AbstractConfig
{
    ...
    {
        $fileName = 'sendcloudv2_servicepointrates.csv';
        /** @var $gridBlock Grid */
        ...
        if ($this->getRequest()->getParam('conditionName')) {
            ...
            $conditionName = $website->getConfig('carriers/sendcloudv2servicepoint/sen_condition_name');
        }
