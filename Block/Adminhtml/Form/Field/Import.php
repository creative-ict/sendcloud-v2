...
namespace SendCloud\SendCloudV2\Block\Adminhtml\Form\Field;
...
class Import extends AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        Event.observe($('carriers_sendcloudv2servicepoint_sen_condition_name'), 'change', checkConditionName.bind(this));
