...
namespace SendCloud\SendCloudV2\Block\Adminhtml\Carrier\Servicepointrate;

use \Magento\Backend\Block\Template\Context;
use \Magento\Backend\Block\Widget\Grid\Extended;
use \Magento\Backend\Helper\Data;
use \SendCloud\SendCloudV2\Model\Carrier\SendcloudServicepoint;
use \SendCloud\SendCloudV2\Model\ResourceModel\Carrier\Servicepointrate\CollectionFactory;
...
class Grid extends Extended
{
     ...
     * @param SendcloudServicepoint $sendcloudservicepoint
     * @param array $data
     */
    public function __construct(
        ...
        SendcloudServicepoint $sendcloudservicepoint,
        array $data = []
    ) {
        $this->_collectionFactory = $collectionFactory;
        $this->_servicepointrate = $sendcloudservicepoint;
